              ...
              <div class="row">
                <div class="col-md-4 pr-md-1">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Username" value="lperez" name="username" disabled>
                  </div>
                </div>
                ...
                <div class="col-md-4 pr-md-1">
                  <div class="form-group">
                    <label>Nombre</label>
                    <input type="text" class="form-control" form="update-my-profile" value="Luis" placeholder="Nombre" name="nombre" required>
                  </div>
                </div>
                <div class="col-md-4 pl-md-1">
                  <div class="form-group">
                    <label>Apellido</label>
                    <input type="text" class="form-control" form="update-my-profile" value="Perez" name="apellido" required>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6 pr-md-1">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" form="update-my-profile" value="luisperez@gmail.com" name="correo" required>
                  </div>
                </div>
                ...
                <div class="col-md-6 pl-md-1">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" form="update-my-profile" value="83621351" name="telefono" required>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" form="update-my-profile" value="Me gusta el pan" name="biografia" required>
