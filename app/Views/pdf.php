...
<head>
<script type="text/javascript"  id="debugbar_loader" data-time="1668981675.234179" src="http://localhost:8080/sistema_ganado/index.php?debugbar"></script><script type="text/javascript"  id="debugbar_dynamic_script"></script><style type="text/css"  id="debugbar_dynamic_style"></style><script class="kint-rich-script">void 0===window.kintShared&&(window.kintShared=function(){"use strict";var e={dedupe:function(e,n){return[].forEach.call(document.querySelectorAll(e),function(e){e!==(n=!n||!n.ownerDocument.contains(n)?e:n)&&e.parentNode.removeChild(e)}),n},runOnce:function(e){"complete"===document.readyState?e():window.addEventListener("load",e)}};return window.addEventListener("click",function(e){var n;e.target.classList.contains("kint-ide-link")&&((n=new XMLHttpRequest).open("GET",e.target.href),n.send(null),e.preventDefault())}),e}());
...
void 0===window.kintMicrotimeInitialized&&(window.kintMicrotimeInitialized=1,window.addEventListener("load",function(){"use strict";var a={},t=Array.prototype.slice.call(document.querySelectorAll("[data-kint-microtime-group]"),0);t.forEach(function(t){var i,e;t.querySelector(".kint-microtime-lap")&&(i=t.getAttribute("data-kint-microtime-group"),e=parseFloat(t.querySelector(".kint-microtime-lap").innerHTML),t=parseFloat(t.querySelector(".kint-microtime-avg").innerHTML),void 0===a[i]&&(a[i]={}),(void 0===a[i].min||a[i].min>e)&&(a[i].min=e),(void 0===a[i].max||a[i].max<e)&&(a[i].max=e),a[i].avg=t)}),t.forEach(function(t){var i,e,r,o,n=t.querySelector(".kint-microtime-lap");null!==n&&(i=parseFloat(n.textContent),o=t.dataset.kintMicrotimeGroup,e=a[o].avg,r=a[o].max,o=a[o].min,i===(t.querySelector(".kint-microtime-avg").textContent=e)&&i===o&&i===r||(n.style.background=e<i?"hsl("+(40-40*((i-e)/(r-e)))+", 100%, 65%)":"hsl("+(40+80*(e===o?0:(e-i)/(e-o)))+", 100%, 65%)"))})}));
    ...
    <!-- CSS Files -->
    <link href=http://localhost:8080/sistema_ganado/public/static/style.css rel="stylesheet">
    <link rel="stylesheet" href=http://localhost:8080/sistema_ganado/public/static/assets/css/paper-dashboard.css?v=2.0.1 />
    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link rel="stylesheet" href=http://localhost:8080/sistema_ganado/public/static/assets/demo/demo.css />
    <link rel="shortcut icon" href=http://localhost:8080/sistema_ganado/public/static/imagenes/favicon.jpg>
...
<div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
        <div class="logo">
            <a class="simple-text logo-mini" href=http://localhost:8080/sistema_ganado>
                <div class="logo-image-small">
                    <img src=http://localhost:8080/sistema_ganado/public/static/imagenes/favicon.jpg>
                </div>
                <!-- <p>CT</p> -->
            </a>
            <a href=http://localhost:8080/sistema_ganado class="simple-text logo-normal">
                La calamidad
            </a>
        </div>
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li>
                    <a href=http://localhost:8080/sistema_ganado/mostrar_ganado>
                        <i class="fa fa-cow"></i>
                        <p>Ganado</p>
                    </a>
                </li>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item btn-rotate dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                <a href="http://localhost:8080/sistema_ganado/index.php/ganado" class="dropdown-item">Ganado</a>                                <a href="http://localhost:8080/sistema_ganado/index.php" class="nav-item dropdown-item">Proveedores</a>                                <a href="http://localhost:8080/sistema_ganado/index.php" class="nav-item dropdown-item">Clientes</a>                                <a href="http://localhost:8080/sistema_ganado/index.php" class="nav-item dropdown-item">Usuarios</a>                                <a href="http://localhost:8080/sistema_ganado/index.php" class="nav-item dropdown-item">Alimentación</a>                                <a href="http://localhost:8080/sistema_ganado/index.php" class="nav-item dropdown-item">Nueva venta</a>                                <a href="http://localhost:8080/sistema_ganado/index.php/compra" class="nav-item dropdown-item">Nueva compra</a>                            </div>
                        <li class="nav-item">
                        ...
                        <li class="nav-item btn-rotate dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                <a href="http://localhost:8080/sistema_ganado/index.php/cuenta" class="nav-item dropdown-item">Cuenta</a>                                <a href="http://localhost:8080/sistema_ganado/index.php/clave" class="nav-item dropdown-item">Nueva clave</a>                                <a href="http://localhost:8080/sistema_ganado/index.php/salir" class="nav-item dropdown-item">Cerrar sesión</a>                            </div>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- DEBUG-VIEW ENDED 1 APPPATH\Views\Front\layout\header.php -->
    ...
    <!-- DEBUG-VIEW START 2 APPPATH\Views\Front\layout\footer.php -->
<footer class="footer">
    <div class="container-fluid">
        <div class="copyright">
            © 2022 creado por
            <a href="https://www.instagram.com/estefany_rizo20/" target="_blank"> Estefany Rizo </a>
            &
            <a href="https://www.instagram.com/estefany_rizo20/" target="_blank">Max Perez </a> <i class="tim-icons icon-heart-2"></i>
        </div>
    </div>
</footer>
<script src="https://kit.fontawesome.com/40b4b2c44e.js" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-Fy6S3B9q64WdZWQUiU+q4/2Lc9npb8tCaSX9FK7E8HnRr0Jz8D6OP9dO5Vg3Q9ct" crossorigin="anonymous"></script>
<script src=http://localhost:8080/sistema_ganado/public/static/assets/js/core/jquery.min.js></script>
<script src=http://localhost:8080/sistema_ganado/public/static/assets/js/core/popper.min.js></script>
<script src=http://localhost:8080/sistema_ganado/public/static/assets/js/plugins/perfect-scrollbar.jquery.min.js></script>
<script src=http://localhost:8080/sistema_ganado/public/static/assets/js/plugins/chartjs.min.js></script>
<script src=http://localhost:8080/sistema_ganado/public/static/assets/js/plugins/bootstrap-notify.js></script>
<script type="text/javascript" src=http://localhost:8080/sistema_ganado/public/static/assets/js/paper-dashboard.min.js?v=2.0.1></script>
<script src=http://localhost:8080/sistema_ganado/public/static/assets/demo/demo.js></script>
<script src=http://localhost:8080/sistema_ganado/public//static/assets/demo/jquery.sharrre.js></script>
<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
<script src= http://localhost:8080/sistema_ganado/public/static/script.js></script>
</div>
</div>
<!-- DEBUG-VIEW ENDED 2 APPPATH\Views\Front\layout\footer.php -->

    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
        </body>

</html>
<!-- DEBUG-VIEW ENDED 3 APPPATH\Views\Front\layout\main.php -->

<!-- DEBUG-VIEW ENDED 4 APPPATH\Views\mostrar_compra.php -->
